...
const Invoice = () => {
  ...
  return (
    <>
      <div className="container mx-auto bg-[#F7F8F9] rounded-lg px-5 mt-5">
        ...
        <button
          className="text-white my-6 text-xl bg-[#E14658] p-2 rounded-lg border-red hover:text-blue-200"
          onClick={generatePDF}
        >
          Download PDF
        </button>
